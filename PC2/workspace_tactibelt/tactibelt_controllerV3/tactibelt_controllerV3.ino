      ...
      if (character=='+'){
        ...
        if (code==10){ // set parameters to buzzer
          if (id_buzz>=0 && id_buzz1<6 && id_buzz2<8){
           setBuzzer(id_buzz,(pwm-48)*10,(tempo1-48), (tempo2-48), (trame-48));
           code=0;
          }
        }
...
void vibrations(){
  ...
  for (int g=0;g<60;g+=10){
     for (int v=0;v<8;v++){
        ...
        /*if (g+v==52){
           Serial.print(pulses[periods[52]]);
           Serial.print(", ");
           Serial.print(tempos1[52]);
           Serial.print(", ");
           Serial.print(periods[52]);
           Serial.print(", ");
